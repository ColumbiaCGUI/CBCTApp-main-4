...
public class FlipCamera : MonoBehaviour
{
    ...
    public void buttonFlipCamera()
    {
        if(isFrontView)
        {
            ...
            // get position and rotation of head. D

            sideCam.transform.position = new Vector3(camDist, 0, 0) + headEmpty.transform.position;

            light1.transform.RotateAround(headEmpty.transform.position, Vector3.up, -90);
            light2.transform.RotateAround(headEmpty.transform.position, Vector3.up, -90);
